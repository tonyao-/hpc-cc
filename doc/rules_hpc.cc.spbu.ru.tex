...
\usepackage{cmap} \usepackage[T2A]{fontenc} \usepackage[utf8]{inputenc} \usepackage[english,russian]{babel}
...
\subsubsection{Пример 1. Запуск скрипта “Hello Word” на 1 ядре}
\begin{lstlisting}
...
\subsubsection{Пример 2. Запуск программы Pi скомпилированной openmpi-1.4 на 4-х нодах}
\begin{lstlisting}
...
\subsubsection{Пример 3. Запуск пакета Firefly с тестовым примером}
\begin{lstlisting}
...
\subsubsection{Пример 4. Запуск теста linpack на 4 ядрах}
\begin{lstlisting}
...
\subsubsection{Пример 5. Мониторинг загруженности кластера}
\begin{lstlisting}
$ ./status-tp -p
Total=368
Free=352
...
\subsubsection{Пример 6. Запуск пакета Gaussian с тестовым примером}
\begin{lstlisting}
...
\subsubsection{Пример 7. Запуск массива задач в среде scilab с различным параметрами}
\begin{lstlisting}
...
\subsubsection{Пример 8. Мониторинг и удаление задания}
...
%Здесь будет информация о железе Т-Платформ
